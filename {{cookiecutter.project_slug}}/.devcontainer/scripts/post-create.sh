...
BASE_STEPS=(
    ...
    "setup_python_environment"{% if cookiecutter.use_cypress == "y" %}
...
{% if cookiecutter.use_cypress == "y" %}setup_cypress_dependencies() {
    local step_id=$1
...
# ----------------------------------------
main() {
    set_workflow_context "$PROJECT_NAME Development Environment Setup"
    log_workflow_start "$PROJECT_NAME Development Environment Setup"
    ...
    {% if cookiecutter.use_cypress == "y" %}# Step: Setup Cypress dependencies
    ...
    log_workflow_end "$PROJECT_NAME Development Environment Setup" "success"

    display_bold_message "$PROJECT_NAME development environment ready!"
}
